<div class="container-fluid">
    ...
    <section class="content">
        <form enctype="multipart/form-data" action="<?php echo base_url('perusahaan/prosesTambah_perusahaan'); ?>" method="post">
            ...
            <button style="margin:10px;" type="submit" class="btn btn-primary float-right btn-lg"><i class="far fa-paper-plane"> Simpan</i></button>
