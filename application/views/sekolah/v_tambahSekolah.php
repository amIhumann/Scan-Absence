<div class="container-fluid">
    ...
    <section class="content">
        <form enctype="multipart/form-data" action="<?php echo base_url('sekolah/prosesTambah_sekolah'); ?>" method="post">
            ...
            <div class=" form-group row">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="text" id="longitude" name="longtitude" class="form-control">
                </div>
            </div>
...
<script>
    ...
    if (curLocation[0] == 0 && curLocation[1] == 0) {
        curLocation = [-7.406934902013996, 112.71154027096266];
    }
