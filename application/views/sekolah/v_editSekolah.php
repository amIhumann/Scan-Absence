<div class="container-fluid">
    ...
    <section class="content">
        <?php foreach ($unit as $un) { ?>
            <form enctype="multipart/form-data" action="<?php echo base_url('sekolah/update_sekolah'); ?>" method="post">
                <div class=" form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        <label>Nama Sekolah</label>
                        <input type="hidden" name="id_sekolah" class="form-control" value="<?php echo $un->id_sekolah ?>">
                        <input type="text" name="nama_sekolah" class="form-control" value="<?php echo $un->nama_sekolah ?>">
                    </div>
                    <div class="col-sm-6">
                        <label>Logo</label>
                ...
                <div class=" form-group row">
                    <div class="col-sm-4 mb-3 mb-sm-0">
                        ...
                        <input type="text" name="alamat_sekolah" class="form-control" value="<?php echo $un->alamat_sekolah ?>">
                    </div>
                    <div class="col-sm-4 mb-3 mb-sm-0">
                ...
                <a href="<?php echo base_url('sekolah/index'); ?>" style="margin:10px;" class="btn btn-danger float-right btn-lg"><i class="fas fa-angle-double-left"></i></a>
            </form>
...
<script>
    ...
    var marker = new L.marker(curLocation, {
        draggable: 'true'
    }).addTo(map).bindPopup("<b><?php echo $un->nama_sekolah ?></b><br>I am a popup.").openPopup();
    <?php } ?>
